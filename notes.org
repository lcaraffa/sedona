...
#+BEGIN_SRC java
  ...
  .config("spark.executor.memory", "10g") // Replace SPARK_EXECUTOR_MEMORY with actual value
  .config("spark.driver.memory", "10g") // Replace SPARK_DRIVER_MEMORY with actual value       
    .getOrCreate()        
   ...
   // v
       al sedona = SedonaContext.create(config)
